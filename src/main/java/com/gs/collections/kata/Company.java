...
public class Company
{
    ...
    {
        if(1 == 1) throw new UnsupportedOperationException("Refactor this code to use GS Collections as part of Exercise 3");
    ...
    public Customer getCustomerNamed(String name)
    {
         ...
         */
//        if(1 == 1) throw new UnsupportedOperationException("Implement this method as part of Exercise 2");
//        return null;
        return this.customers.detect(c -> name.equals(c.getName()));
    }
}